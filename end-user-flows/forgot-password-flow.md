...
flowchart TD
  ...
  subgraph Recovery["Account recovery"]
    ...
    verify --> found{Verified identifier matches<br/>an existing user account}
  ...
  note_guard[The submitted recovery method is re-validated by the backend<br/>before the recovery flow can continue.]

  note_methods -.-> fp1
  note_existence -.-> send_code
  note_session -.-> reset0
  note_guard -.-> send_code
```
