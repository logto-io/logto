...
/**
  The organization API resource scopes (permissions) that client ID metadata document (CIMD) clients of
  the tenant can request. The scopes are granted to users through organization roles.
