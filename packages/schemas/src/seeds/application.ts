import { generateStandardSecret, generateStandardId, buildSeedId } from '@logto/shared/universal';
...
export const getAdminConsoleApplicationId = (): string => buildSeedId(adminConsoleApplicationId);

/** Get the demo app application ID in the appropriate format. */
export const getDemoAppApplicationId = (): string => buildSeedId(demoAppApplicationId);

/** Get the account center application ID in the appropriate format. */
export const getAccountCenterApplicationId = (): string => buildSeedId(accountCenterApplicationId);
