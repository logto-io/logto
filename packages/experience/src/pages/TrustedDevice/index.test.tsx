...
describe('<TrustedDevice />', () => {
  ...
  it('submits an accepted decision and redirects', async () => {
    ...
    expect(getByText('mfa.trust_this_device_title')).not.toBeNull();
    expect(getByText('mfa.trust_this_device_description')).not.toBeNull();

    fireEvent.click(getByText('mfa.trust_this_device'));
