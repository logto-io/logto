...
export const blockchainConnectors = [
  {
    id: 'FE8QXN1VsrOG0xdWFDJZ9',
    target: 'metamask',
    platform: ConnectorPlatform.Web,
    ...
    logoDark: null,
    name: {
      en: 'Sign in with MetaMask',
      'pt-PT': 'Entrar com MetaMask',
      'zh-CN': '使用 MetaMask 登录',
      'tr-TR': 'MetaMask ile giriş yap',
      ko: 'MetaMask 로그인',
    },
    description: {
      en: 'Sign in with MetaMask!!',
