...
describe('application maxAllowedGrants', () => {
  ...
  it('should create application with maxAllowedGrants and get it', async () => {
  ...
  it('should update maxAllowedGrants and get updated value', async () => {
    const application = await createApplication(generateTestName(), ApplicationType.Traditional);
  ...
  it('should remove maxAllowedGrants after update without the field', async () => {
    const application = await createApplication(generateTestName(), ApplicationType.Traditional, {
  ...
  it('should not trigger revocation if no maxAllowedGrants config is found', async () => {
  ...
  it('should not trigger revocation if maxAllowedGrants is not exceeded', async () => {
    await enableAllPasswordSignInMethods();
  ...
  it('should revoke the oldest grant when maxAllowedGrants is exceeded', async () => {
    await enableAllPasswordSignInMethods();
