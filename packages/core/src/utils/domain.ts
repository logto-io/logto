...
/**
 * Normalizes a user-supplied hostname for storage and comparison: DNS names are case-insensitive,
 * cannot carry surrounding whitespace, and `example.com.` is equivalent to `example.com`.
 */
