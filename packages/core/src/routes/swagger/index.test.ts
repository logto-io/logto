      ...
      [supplement],
      {
        ...
        paths: {
          '/api/my-account/mfa-verifications/totp': {
            put: {
              operationId: 'ReplaceTotpMfaVerification',
              responses: {
                204: {
        ...
        'application/json': {
          schema: {
            ...
            properties: {
              secret: {
                type: 'string',
                description: 'The new TOTP secret for the replacement authenticator app.',
              },
              code: {
                type: 'string',
                description:
                  'The TOTP code generated from the new secret to confirm the replacement.',
              },
            },
          },
        },
