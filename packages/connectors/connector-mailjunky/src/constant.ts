...
/**
 * MailJunky send API. Dashboard may show `/api/v1/email/send`; the route that responds
 * with JSON (e.g. 401 for invalid key) is `POST .../api/v1/emails/send` on this host.
 */
export const endpoint = 'https://mailjunky.ai/api/v1/emails/send';

export const defaultMetadata: ConnectorMetadata = {
  id: 'mailjunky-email-service',
  target: 'mailjunky-mail',
  platform: null,
  name: {
    en: 'MailJunky Email',
    'zh-CN': 'MailJunky 邮件',
  ...
  formItems: [
    {
      ...
      required: true,
      placeholder: '<your-mailjunky-api-key>',
    },
    {
      key: 'fromEmail',
      label: 'From Email',
