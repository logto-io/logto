...
type Props = {
  ...
  readonly restoreActionTip?: string;
  readonly restoreActionSuccessTip?: string;
};
/**
    ...
    <div className={classNames(className, styles.codeEditor)}>
      <header>
        ...
        <div className={styles.actionButtons}>
          {enabledActions.includes('restore') && restoreActionTip && restoreActionSuccessTip && (
            <CodeRestoreButton
              className={styles.iconButton}
              actionTip={restoreActionTip}
              actionSuccessTip={restoreActionSuccessTip}
              onClick={() => {
