...
Provide the email domains of your organization on the connector settings tab. This will enabled the SSO connector as an authentication method for those users.
