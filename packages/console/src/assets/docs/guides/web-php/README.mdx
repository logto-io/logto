...
{`Route::get('/sign-in', function () {
  return redirect($client->signIn('${props.redirectUris[0] || "http://localhost:3000/callback"}'));
});`}
</Code>
...
<Code title="index.php" className="language-php">
{`Route::get('/sign-in', function () {
  return redirect($client->signIn('${props.redirectUris[0] || "http://localhost:3000/callback"}', InteractionMode::signUp));
});`}
</Code>
