        ...
        <>
          ...
          >
            <Editor
              ...
              value={getEventTypeDefinition(hookType)}
              height="320px"
              theme="logto-dark"
          ...
          >
            <Editor
              language="typescript"
              className={styles.sampleCode}
              value={getResultTypeDefinition(hookType)}
              height="280px"
              theme="logto-dark"
              options={typeDefinitionCodeEditorOptions}
            />
          ...
          >
            <div className={tabContentStyles.description}>
              {t('inline_hooks.fetch_external_data.description')}
            </div>
            <Editor
              language="typescript"
              className={styles.sampleCode}
          ...
          >
            ...
            <div className={tabContentStyles.description}>
              {t('inline_hooks.environment_variables.sample_code')}
            </div>
            <Editor
              language="typescript"
              className={styles.sampleCode}
