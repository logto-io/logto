...
import useDocumentationLocale from '@/hooks/use-documentation-locale';
...
const useGetStartedMetadata = () => {
  const documentationLocale = useDocumentationLocale();
    ...
    const metadataItems: GetStartedMetadata[] = [
      ...
      },
      {
        ...
        onClick: () => {
          ...
          window.open(
            `https://docs.logto.io${documentationLocale}/docs/tutorials/get-started/further-readings/`,
            '_blank'
          );
        },
      },
