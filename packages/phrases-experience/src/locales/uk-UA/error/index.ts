...
const error = {
	...
	username_should_not_start_with_number:
		"Ім'я користувача не повинно починатися з цифри",
	...
	invalid_session:
		"Сесію не знайдено. Будь ласка, поверніться назад і увійдіть знову.",
	timeout: "Час очікування вийшов. Будь ласка, спробуйте ще раз пізніше.",
	password_rejected,
	sso_not_enabled:
		"Єдиний вхід (SSO) не ввімкнено для цього облікового запису.",
	invalid_link: "Недійсне посилання",
	invalid_link_description:
		"Ваш одноразовий токен міг спливти або більше не є дійсним.",
