const description = {
	...
	agree_with_terms_modal:
		"Щоб продовжити, будь ласка, погодьтеся з <link></link>.",
	...
	resend_after_seconds:
		"Не отримали код? Повторна відправка через <span>{{seconds}}</span> секунд",
	resend_passcode: "Не отримали код? <a>Надіслати повторно</a>",
	create_account_id_exists:
		"Обліковий запис з {{type}} {{value}} вже існує, бажаєте увійти?",
	link_account_id_exists:
		"Обліковий запис з {{type}} {{value}} вже існує. Бажаєте зв’язати?",
	sign_in_id_does_not_exist:
		"Обліковий запис з {{type}} {{value}} не існує, бажаєте створити новий?",
	sign_in_id_does_not_exist_alert:
		"Обліковий запис з {{type}} {{value}} не існує.",
	...
	social_link_email_or_phone:
		"Ви можете зв’язати іншу електронну пошту або телефон",
	...
	single_sign_on_enabled:
		"Єдиний вхід (SSO) увімкнено для цього облікового запису",
	...
	authorize_personal_data_usage:
		"Дозволити використання ваших персональних даних:",
	...
	authorize_agreement:
		"Авторизуючи доступ, ви погоджуєтесь з <link></link> {{name}}.",
	...
	identifier_sign_in_description:
		"Введіть {{types, list(type: disjunction;)}} для входу.",
