const description = {
  ...
  password_expired_description: '您的密碼已過期，必須重置後才能登錄。',
  password_expiration_reminder: '您的密碼即將過期',
  password_expiration_reminder_description: '您的密碼將在 {{days}} 天後過期。建議立即重置。',
  ...
  about_yourself: '告訴我們一些關於你自己的事情',
  verify_identity: '驗證你的身分',
