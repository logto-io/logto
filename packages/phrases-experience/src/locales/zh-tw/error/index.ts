...
const error = {
  ...
  username_too_short: '使用者名稱至少應有 {{min}} 個字元。',
  username_too_long: '使用者名稱最多可以有 {{max}} 個字元。',
  username_uppercase_not_allowed: '使用者名稱中不允許使用大寫字母。',
  username_lowercase_not_allowed: '使用者名稱中不允許使用小寫字母。',
  username_numbers_not_allowed: '使用者名稱中不允許使用數字。',
  username_underscore_not_allowed: '使用者名稱中不允許使用下劃線。',
  invalid_email: '無效的郵箱',
