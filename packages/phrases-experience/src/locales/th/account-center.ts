const account_center = {
  ...
  email: {
    ...
    remove_confirmation_description:
      'การลบอีเมลหลักของคุณจะไม่ปิดใช้งานการเข้าสู่ระบบ ตรวจสอบให้แน่ใจว่าคุณได้กำหนดค่าวิธีการเข้าสู่ระบบอื่นไว้แล้ว (เช่น รหัสผ่านหรือบัญชีโซเชียล)',
  },
  phone: {
    ...
    verification_required: 'การยืนยันหมดอายุ โปรดยืนยันตัวตนอีกครั้ง',
    remove_confirmation_description:
      'การลบหมายเลขโทรศัพท์หลักของคุณจะไม่ปิดใช้งานการเข้าสู่ระบบ ตรวจสอบให้แน่ใจว่าคุณได้กำหนดค่าวิธีการเข้าสู่ระบบอื่นไว้แล้ว (เช่น รหัสผ่านหรือบัญชีโซเชียล)',
  },
  username: {
