const account_center = {
  ...
  mfa: {
    totp_already_added: 'คุณเพิ่มแอปยืนยันตัวตนแล้ว โปรดลบแอปที่มีอยู่ก่อน',
    totp_not_enabled: 'แอปยืนยันตัวตนยังไม่เปิดใช้งาน โปรดติดต่อผู้ดูแลระบบเพื่อเปิดใช้งาน',
  },
  update_success: {
    default: {
      title: 'อัปเดตสำเร็จ',
    ...
    totp: {
      title: 'เพิ่มแอปยืนยันตัวตนแล้ว!',
      description: 'แอปยืนยันตัวตนของคุณเชื่อมต่อกับบัญชีเรียบร้อยแล้ว',
    },
  },
};
