const mfa = {
  ...
  new_backup_codes_generated:
    'รหัสสำรองใหม่ได้แทนที่รหัสเก่าของคุณแล้ว กรุณาบันทึกไว้ในที่ปลอดภัยโดยเร็วที่สุด',
  ...
  trust_this_device_one: 'ไม่ต้องถามอีกบนอุปกรณ์นี้เป็นเวลา {{count}} วัน',
  trust_this_device_two: 'ไม่ต้องถามอีกบนอุปกรณ์นี้เป็นเวลา {{count}} วัน',
  trust_this_device_few: 'ไม่ต้องถามอีกบนอุปกรณ์นี้เป็นเวลา {{count}} วัน',
  trust_this_device_many: 'ไม่ต้องถามอีกบนอุปกรณ์นี้เป็นเวลา {{count}} วัน',
  trust_this_device_other: 'ไม่ต้องถามอีกบนอุปกรณ์นี้เป็นเวลา {{count}} วัน',
