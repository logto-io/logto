const description = {
  ...
  resend_after_seconds: 'Stále jsi ho neobdržel/a? Odeslat znovu za <span>{{seconds}}</span> sekund',
  ...
  link_account_id_exists:
    'Účet s {{type}} {{value}} již existuje. Chceš ho propojit?',
  ...
  social_identity_exist:
    '{{type}} {{value}} je propozen s jiným účtem. Zkus prosím jiný {{type}}.',
