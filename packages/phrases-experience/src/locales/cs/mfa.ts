const mfa = {
  ...
  trust_this_device_one: 'Na tomto zařízení se znovu neptat po dobu {{count}} dne',
  trust_this_device_two: 'Na tomto zařízení se znovu neptat po dobu {{count}} dnů',
  trust_this_device_few: 'Na tomto zařízení se znovu neptat po dobu {{count}} dnů',
  trust_this_device_many: 'Na tomto zařízení se znovu neptat po dobu {{count}} dne',
  trust_this_device_other: 'Na tomto zařízení se znovu neptat po dobu {{count}} dnů',
