const mfa = {
  ...
  onboarding_description:
    'Proteja sua conta com a verificação em duas etapas. Escolha um ou mais métodos: Passkey, aplicativo autenticador (OTP), código de verificação por SMS ou códigos de backup.',
  ...
  add_another_mfa_description:
    'Selecione outra maneira de verificar sua identidade ao fazer login.',
  ...
  new_backup_codes_generated:
    'Novos códigos de backup substituíram seus códigos antigos. Salve-os em um local seguro o mais rápido possível.',
  ...
  trust_this_device_one: 'Não perguntar novamente neste dispositivo por {{count}} dia',
  trust_this_device_two: 'Não perguntar novamente neste dispositivo por {{count}} dias',
  trust_this_device_few: 'Não perguntar novamente neste dispositivo por {{count}} dias',
  trust_this_device_many: 'Não perguntar novamente neste dispositivo por {{count}} dias',
  trust_this_device_other: 'Não perguntar novamente neste dispositivo por {{count}} dias',
