const mfa = {
  ...
  new_backup_codes_generated:
    'Novos códigos de backup substituíram os seus códigos antigos. Guarde-os num local seguro o mais rapidamente possível.',
  ...
  trust_this_device_one: 'Não voltar a perguntar neste dispositivo durante {{count}} dia',
  trust_this_device_two: 'Não voltar a perguntar neste dispositivo durante {{count}} dias',
  trust_this_device_few: 'Não voltar a perguntar neste dispositivo durante {{count}} dias',
  trust_this_device_many: 'Não voltar a perguntar neste dispositivo durante {{count}} dias',
  trust_this_device_other: 'Não voltar a perguntar neste dispositivo durante {{count}} dias',
