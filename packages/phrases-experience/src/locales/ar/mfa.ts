const mfa = {
  ...
  trust_this_device_one: 'لا تطلب التحقق مرة أخرى على هذا الجهاز لمدة يوم واحد',
  trust_this_device_two: 'لا تطلب التحقق مرة أخرى على هذا الجهاز لمدة يومين',
  trust_this_device_few: 'لا تطلب التحقق مرة أخرى على هذا الجهاز لمدة {{count}} أيام',
  trust_this_device_many: 'لا تطلب التحقق مرة أخرى على هذا الجهاز لمدة {{count}} يومًا',
  trust_this_device_other: 'لا تطلب التحقق مرة أخرى على هذا الجهاز لمدة {{count}} يوم',
