const description = {
  ...
  device_activation_success: '你的设备已连接！',
  device_activation_success_description: '请返回你的设备继续。',
  ...
  password_expired: '您的密码已过期',
  password_expired_description: '您的密码已过期，必须重置后才能登录。',
  password_expiration_reminder: '您的密码即将过期',
  password_expiration_reminder_description: '您的密码将在 {{days}} 天后过期。建议立即重置。',
