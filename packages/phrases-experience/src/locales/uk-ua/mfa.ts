const mfa = {
  ...
  enter_email_verification_code_description:
    'Для цього облікового запису увімкнено двоетапну автентифікацію. Будь ласка, введіть код підтвердження, надісланий на вашу адресу електронної пошти.',
  enter_phone_verification_code: 'Введіть SMS‑код підтвердження',
  enter_phone_verification_code_description:
    'Для цього облікового запису увімкнено двоетапну автентифікацію. Будь ласка, введіть SMS‑код підтвердження, надісланий на ваш номер телефону.',
