const mfa = {
  ...
  new_backup_codes_generated:
    'Нові резервні коди замінили ваші старі коди. Збережіть їх у безпечному місці якнайшвидше.',
  ...
  trust_this_device_one: 'Не запитувати знову на цьому пристрої протягом {{count}} дня',
  trust_this_device_two: 'Не запитувати знову на цьому пристрої протягом {{count}} днів',
  trust_this_device_few: 'Не запитувати знову на цьому пристрої протягом {{count}} днів',
  trust_this_device_many: 'Не запитувати знову на цьому пристрої протягом {{count}} днів',
  trust_this_device_other: 'Не запитувати знову на цьому пристрої протягом {{count}} дня',
