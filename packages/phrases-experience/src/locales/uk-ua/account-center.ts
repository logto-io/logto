const account_center = {
  ...
  email: {
    ...
    remove_confirmation_description:
      'Видалення основної електронної пошти не вимкне вхід. Переконайтеся, що у вас налаштовано інший метод входу (наприклад, пароль або соціальний обліковий запис).',
  },
  phone: {
    ...
    verification_required: 'Термін перевірки минув. Підтвердіть свою особу ще раз.',
    remove_confirmation_description:
      'Видалення основного телефону не вимкне вхід. Переконайтеся, що у вас налаштовано інший метод входу (наприклад, пароль або соціальний обліковий запис).',
  },
  username: {
