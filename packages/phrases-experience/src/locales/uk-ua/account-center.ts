const account_center = {
  ...
  mfa: {
    totp_already_added: 'Ви вже додали застосунок-автентифікатор. Спочатку видаліть наявний.',
    totp_not_enabled:
      'Застосунок-автентифікатор не ввімкнено. Зверніться до адміністратора, щоб увімкнути його.',
  },
  update_success: {
    default: {
    ...
    totp: {
      title: 'Застосунок-автентифікатор додано!',
      description: "Ваш застосунок-автентифікатор успішно прив'язано до облікового запису.",
    },
  },
};
