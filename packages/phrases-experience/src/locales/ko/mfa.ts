const mfa = {
  ...
  trust_this_device_one: '이 기기에서는 {{count}}일 동안 다시 묻지 않기',
  trust_this_device_two: '이 기기에서는 {{count}}일 동안 다시 묻지 않기',
  trust_this_device_few: '이 기기에서는 {{count}}일 동안 다시 묻지 않기',
  trust_this_device_many: '이 기기에서는 {{count}}일 동안 다시 묻지 않기',
  trust_this_device_other: '이 기기에서는 {{count}}일 동안 다시 묻지 않기',
