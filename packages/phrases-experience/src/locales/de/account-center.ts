const account_center = {
  ...
  mfa: {
    ...
    totp_not_enabled:
      'Authenticator-App ist nicht aktiviert. Bitte wenden Sie sich an Ihren Administrator, um sie zu aktivieren.',
  ...
  update_success: {
    ...
    totp: {
      ...
      description: 'Ihre Authenticator-App wurde erfolgreich mit Ihrem Konto verknüpft.',
    },
    backup_code: {
