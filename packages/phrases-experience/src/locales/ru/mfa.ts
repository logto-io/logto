const mfa = {
  ...
  enter_email_verification_code_description:
    'Для этой учетной записи включена двухэтапная аутентификация. Пожалуйста, введите код подтверждения, отправленный на ваш адрес электронной почты.',
  enter_phone_verification_code: 'Введите SMS‑код подтверждения',
  enter_phone_verification_code_description:
    'Для этой учетной записи включена двухэтапная аутентификация. Пожалуйста, введите SMS‑код подтверждения, отправленный на ваш номер телефона.',
