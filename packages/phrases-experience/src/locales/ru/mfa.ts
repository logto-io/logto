const mfa = {
  ...
  trust_this_device_one: 'Не спрашивать снова на этом устройстве в течение {{count}} дня',
  trust_this_device_two: 'Не спрашивать снова на этом устройстве в течение {{count}} дней',
  trust_this_device_few: 'Не спрашивать снова на этом устройстве в течение {{count}} дней',
  trust_this_device_many: 'Не спрашивать снова на этом устройстве в течение {{count}} дней',
  trust_this_device_other: 'Не спрашивать снова на этом устройстве в течение {{count}} дня',
