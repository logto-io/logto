const mfa = {
  ...
  onboarding: 'Включить двухфакторную аутентификацию',
  onboarding_description:
    'Защитите свой аккаунт с помощью двухфакторной аутентификации. Выберите один или несколько методов: ключ доступа, приложение аутентификации (OTP), SMS-код верификации или резервные коды.',
  enable_mfa: 'Включить двухфакторную аутентификацию',
  ...
  new_backup_codes_generated:
    'Новые резервные коды заменили ваши старые коды. Сохраните их в надёжном месте как можно скорее.',
  ...
  trust_this_device_title: 'Доверять этому устройству',
  trust_this_device_description:
    'При последующих входах на этом устройстве можно пропустить проверку MFA.',
  trust_this_device_one: 'Доверять этому устройству в течение {{count}} дня',
  trust_this_device_two: 'Доверять этому устройству в течение {{count}} дней',
  trust_this_device_few: 'Доверять этому устройству в течение {{count}} дней',
  trust_this_device_many: 'Доверять этому устройству в течение {{count}} дней',
  trust_this_device_other: 'Доверять этому устройству в течение {{count}} дня',
