const account_center = {
  ...
  mfa: {
    totp_already_added: 'Вы уже добавили приложение-аутентификатор. Сначала удалите существующее.',
    totp_not_enabled:
      'Приложение-аутентификатор не включено. Обратитесь к администратору для его включения.',
  },
  update_success: {
    default: {
    ...
    totp: {
      title: 'Приложение-аутентификатор добавлено!',
      description: 'Ваше приложение-аутентификатор успешно привязано к аккаунту.',
    },
  },
};
