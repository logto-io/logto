const account_center = {
  ...
  email: {
    ...
    remove_confirmation_description:
      'Удаление основной электронной почты не отключит вход. Убедитесь, что у вас настроен другой способ входа (например, пароль или социальная учетная запись).',
  },
  phone: {
    ...
    verification_required: 'Срок действия проверки истёк. Подтвердите личность ещё раз.',
    remove_confirmation_description:
      'Удаление основного телефона не отключит вход. Убедитесь, что у вас настроен другой способ входа (например, пароль или социальная учетная запись).',
  },
  username: {
