const custom_profile_fields = {
  ...
  name_conflict_sign_in_identifier:
    'اسم الحقل غير صالح. مفاتيح معرف تسجيل الدخول المحجوزة: {{name}}.',
  name_conflict_built_in_prop:
    'اسم الحقل غير صالح. أسماء خصائص ملف المستخدم المدمجة المحجوزة: {{name}}.',
  name_conflict_custom_data: 'اسم الحقل غير صالح. مفاتيح البيانات المخصصة المحجوزة: {{name}}.',
