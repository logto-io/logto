const session = {
  ...
  trusted_device_suggest_opt_in: 'اختر ما إذا كنت تريد الوثوق بهذا الجهاز.',
  step_up: {
    ...
    require_verification: 'يلزم إجراء تحقق إضافي لاستيفاء سياق المصادقة المطلوب.',
  },
  passkey_sign_in: {
  ...
  password_expiration: {
    reset_not_allowed:
      'لا يُسمح بإعادة تعيين كلمة المرور إلا بعد انتهاء صلاحية كلمة المرور في جلسة تسجيل الدخول الحالية.',
  },
  sso_enabled:
