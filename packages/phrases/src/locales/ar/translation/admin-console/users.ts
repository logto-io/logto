const users = {
  ...
  subtitle:
    '.إدارة هويات المستخدمين بما في ذلك إنشاء المستخدمين، تعديل معلومات المستخدم، عرض سجلات المستخدم، إعادة تعيين كلمة المرور وحذف المستخدمين',
  create: 'إضافة مستخدم',
  ...
  placeholder_description:
    'يحتوي كل مستخدم على ملف تعريف يحتوي على جميع معلومات المستخدم. يتكون من البيانات الأساسية وهويات التواصل الاجتماعي والبيانات المخصصة.',
  dev_tenant_data_retention_notice:
    'في مستأجري التطوير، يتم حذف حسابات المستخدمين الأقدم من 90 يومًا تلقائيًا. <a>تعرف على المزيد</a>',
};
