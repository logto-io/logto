const user_details = {
  ...
  expire_password: {
    button: 'إنهاء الصلاحية',
    title: 'هل أنت متأكد أنك تريد إنهاء صلاحية كلمة المرور هذه؟',
    content:
      'سيُطلب من المستخدم إعادة تعيين كلمة المرور الخاصة به عند تسجيل الدخول التالي. لا يمكن التراجع عن هذا الإجراء.',
    success: 'تم وضع علامة على كلمة مرور المستخدم على أنها منتهية الصلاحية.',
    not_enabled_tooltip: 'سياسة انتهاء صلاحية كلمة المرور غير مفعلة.',
  },
  ...
  sessions: {
    title: 'الجلسات',
    description:
      'إدارة الجلسات التي تحتفظ بها خادم التفويض Logto. إلغاء جلسة Logto هنا يمنع الموافقة التلقائية على طلبات التفويض المستقبلية.',
    field_name: 'الجلسات',
  ...
  third_party_apps: {
    ...
    revoke_access_description:
      'سيؤدي هذا إلى إلغاء وصول التطبيق إلى حساب هذا المستخدم عبر جميع الأجهزة. يجب على المستخدم إعادة التفويض لاستعادة الوصول. قد تظل رموز الوصول التي أُصدرت سابقًا صالحة حتى انتهاء صلاحيتها.',
  },
  connections: {
    title: 'الاتصال',
    description:
