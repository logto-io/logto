const applications = {
  ...
  dynamic_app: {
    ...
    beta_notice:
      'التطبيق الديناميكي في مرحلة بيتا حاليًا. نرحب باستكشافه و<ContactLink>مشاركة ملاحظاتك</ContactLink>.',
    ...
    enable_confirm_modal: {
      ...
      beta_pricing_notice:
        'التطبيق الديناميكي مجاني أثناء مرحلة بيتا. قد تُطبَّق رسوم إضافية بعد انتهاء مرحلة بيتا. سنُعلمك مسبقًا، ويمكنك إيقافه في أي وقت.',
    },
