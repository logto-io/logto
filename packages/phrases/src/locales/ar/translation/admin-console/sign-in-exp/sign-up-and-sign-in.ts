const sign_up_and_sign_in = {
  ...
  sign_up: {
    ...
    authentication_description:
      'سيكون على المستخدمين إكمال جميع الإجراءات المحددة في التدفق.',
  ...
  tip: {
    ...
    password_auth:
      'هذا أمر ضروري حيث قمت بتمكين خيار إنشاء كلمة مرور أثناء عملية التسجيل.',
    ...
    delete_sign_in_method:
      'هذا أمر ضروري حيث قمت باختيار {{identifier}} كمعرف مطلوب.',
  },
  advanced_options: {
    title: 'خيارات متقدمة',
