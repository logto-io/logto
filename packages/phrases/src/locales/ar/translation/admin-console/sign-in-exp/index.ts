...
const sign_in_exp = {
  ...
  branding: {
    ...
    hide_logto_branding_self_hosted_note:
      'هذه الميزة متاحة مع <selfHosted>خطط الاستضافة الذاتية</selfHosted>. وهي متاحة أيضًا بشكل أصلي في <a>Logto Cloud</a>.',
  },
  branding_uploads: {
    app_logo: {
      title: 'شعار التطبيق',
  ...
  custom_ui: {
    ...
    bring_your_ui_self_hosted_card_description:
      'حمّل واجهة تسجيل الدخول المخصصة الخاصة بك مع <selfHosted>خطط الاستضافة الذاتية</selfHosted>. يمكنك أيضًا تحميلها مباشرةً إلى <a>Logto Cloud</a>.',
  ...
  account_center: {
    ...
    profile_fields: {
      ...
      disabled_hint: {
        name: 'لإضافة هذا الحقل، عيّن أولاً صلاحية "الاسم" إلى "تحرير/للقراءة فقط" في قسم ملف المستخدم أدناه.',
        avatar:
          'لإضافة هذا الحقل، عيّن أولاً صلاحية "الصورة الرمزية" إلى "تحرير/للقراءة فقط" في قسم ملف المستخدم أدناه.',
        profile:
          'لإضافة هذا الحقل، عيّن أولاً صلاحية "الملف الشخصي" إلى "تحرير/للقراءة فقط" في قسم ملف المستخدم أدناه.',
        custom_data:
          'لإضافة هذا الحقل، عيّن أولاً صلاحية "بيانات مخصصة" إلى "تحرير/للقراءة فقط" في قسم ملف المستخدم أدناه.',
      },
    },
    ...
    prebuilt_ui: {
      ...
      tooltips: {
        ...
        sessions: 'عرض وإدارة جلساتك النشطة عبر الأجهزة',
      },
