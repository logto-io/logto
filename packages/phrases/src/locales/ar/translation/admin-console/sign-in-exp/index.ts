...
const sign_in_exp = {
  ...
  custom_ui: {
    ...
    bring_your_ui_oss_description: 'في OSS، يمكنك عمل fork للشيفرة لتخصيص واجهة تسجيل الدخول.',
    bring_your_ui_oss_card_description:
      'حمّل موارد واجهة تسجيل الدخول المخصصة إلى Logto Cloud دون أي إعدادات.',
