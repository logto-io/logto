const connectors = {
  ...
  guide: {
    ...
    callback_uri_description:
      'عناوين URI لإعادة التوجيه هي الوجهات التي يُعاد توجيه المستخدمين إليها بعد التفويض عبر وسائل التواصل الاجتماعي. أضف جميع العناوين المعروضة إلى إعدادات موفر الهوية (IdP) الخاص بك.',
  ...
  create_form: {
    ...
    email_connector_upsell: {
      title: 'خدمة البريد الإلكتروني المدمجة من Logto',
      description:
        'إرسال بريد إلكتروني بدون أي إعدادات. أرسل رموز التحقق وروابط السحر مباشرةً من البداية.',
      self_hosted_description:
        'إرسال بريد إلكتروني بدون أي إعدادات مع خطة الاستضافة الذاتية للمؤسسات. أرسل رموز التحقق وروابط السحر مباشرةً من البداية، أو جرّب Logto Cloud.',
    },
