const connectors = {
  page_title: 'الموصلات',
  title: 'الموصلات',
  subtitle: 'قم بإعداد الموصلات لتمكين تجربة تسجيل الدخول بدون كلمة مرور والتسجيل بواسطة وسائل التواصل الاجتماعي',
  ...
  guide: {
    ...
    target_tip:
      'قيمة "اسم مزود الهوية" يمكن أن تكون سلسلة معرف فريد لتمييز هوياتك الاجتماعية.',
    target_tip_standard:
