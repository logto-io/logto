const enterprise_sso_details = {
  ...
  trust_unverified_email_tip_oidc:
    'قد لا يعيد موصل OIDC مطالبة `email_verified`، مما يعني أن عناوين البريد الإلكتروني من موفر الهوية قد لا تكون مضمونة التحقق. بشكل افتراضي، لن يقوم Logto بمزامنة عناوين البريد الإلكتروني غير المُحقَّقة إلى ملف تعريف المستخدم. فعّل هذا الخيار فقط إذا كنت تثق بجميع عناوين البريد الإلكتروني من موفر الهوية.',
  offline_access: {
