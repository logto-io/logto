const profile = {
  ...
  mfa: {
    ...
    passkeys_count_two: 'مفتاحا مرور {{count}}',
    passkeys_count_few: '{{count}} مفاتيح مرور',
    passkeys_count_many: '{{count}} مفتاح مرور',
    passkeys_count_other: '{{count}} مفتاح مرور',
    backup_codes_count_one: 'رمز {{count}} متاح',
    backup_codes_count_two: 'رمزان {{count}} متاحان',
    backup_codes_count_few: '{{count}} رموز متاحة',
    backup_codes_count_many: '{{count}} رمز متاح',
