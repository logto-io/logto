const profile = {
  ...
  description:
    'قم بتغيير إعدادات حسابك وإدارة معلوماتك الشخصية هنا لضمان أمان حسابك.',
  settings: {
  ...
  code: {
    ...
    enter_verification_code_subtitle:
      'تم إرسال رمز التحقق إلى <strong>{{target}}</strong>',
  ...
  delete_account: {
    ...
    p: {
      ...
      has_admin_role:
        'نظرًا لأن لديك دور المسؤول في المستأجر التالي ، سيتم حذفه مع حسابك:',
    ...
    issues: {
      ...
      paid_plan_other:
        'المستأجرات التالية لديها خطط مدفوعة ، يرجى إلغاء الاشتراك أولاً:',
    ...
    about_to_start_deletion:
      'أنت على وشك بدء عملية الحذف ولا يمكن التراجع عن هذا الإجراء.',
