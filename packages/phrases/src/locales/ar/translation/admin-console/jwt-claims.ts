const jwt_claims = {
  ...
  user_jwt: {
    ...
    custom_data_in_id_token: {
      title: 'إضافة بيانات المستخدم المخصصة إلى رمز الهوية',
      tip: 'رمز الهوية هو تأكيد الهوية الذي يتلقاه العميل بعد تسجيل الدخول لإثبات هوية المستخدم. إنه مخصص للعميل، ويحتوي على مطالبات هوية المستخدم للعرض أو إنشاء الجلسة.',
      description:
        'تمكين لتضمين <a>بيانات المستخدم المخصصة</a> الخاصة بك في رمز الهوية، مما يسمح للعملاء بالوصول إلى تفاصيل الهوية هذه على الفور دون الحاجة إلى استدعاءات ملف تعريف إضافية.',
    },
  },
