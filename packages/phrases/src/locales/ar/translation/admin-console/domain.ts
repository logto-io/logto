const domain = {
  ...
  custom: {
    ...
    verification_files: {
      title: 'ملفات التحقق من النطاق',
      description:
        'قدّم ملفات نصية أو JSON صغيرة عبر هذا النطاق المخصص للتحقق من ملكية النطاق لدى خدمات الجهات الخارجية.',
      add: 'إضافة ملف تحقق',
      empty: 'لم يتم تكوين أي ملفات تحقق.',
      path: 'مسار الملف',
      content_type: 'نوع المحتوى',
      content_type_text: 'نص عادي',
      content_type_json: 'JSON',
      content: 'محتوى الملف',
      content_placeholder: 'الصق المحتوى الدقيق لملف التحقق',
      required: 'هذا الحقل مطلوب.',
      invalid_path:
        'استخدم اسم ملف بامتداد في جذر النطاق، أو مسارًا ضمن /.well-known/. يُسمح فقط بالحروف والأرقام والنقاط والشرطات والشرطات السفلية.',
      duplicate_path: 'يوجد ملف تحقق يستخدم هذا المسار بالفعل.',
      content_too_long: 'يجب ألا يتجاوز محتوى الملف 16,384 حرفًا.',
      invalid_json: 'أدخل محتوى JSON صالحًا.',
    },
  },
  default: {
