const security = {
  ...
  sentinel_policy: {
    ...
    card_description_1:
      'القفل متاح لجميع المستخدمين بالإعدادات الافتراضية، ولكن يمكنك تخصيصه للمزيد من التحكم.',
    card_description_2:
      'قفل مؤقت لمعرّف بعد عدة محاولات فاشلة للمصادقة (على سبيل المثال، كلمة مرور خاطئة متتالية أو رمز تحقق) لمنع الوصول بالقوة الغاشمة.',
