const security = {
  ...
  password_policy: {
    ...
    password_expiration: 'انتهاء صلاحية كلمة المرور',
    password_expiration_description:
      'اطلب من المستخدمين إعادة تعيين كلمة المرور الخاصة بهم بعد عدد محدد من الأيام. لا يتأثر المستخدمون الذين يسجلون الدخول عبر SSO أو مفتاح المرور.',
    enable_password_expiration: 'تفعيل انتهاء صلاحية كلمة المرور',
    enable_password_expiration_description:
      'اطلب من المستخدمين إعادة تعيين كلمة المرور الخاصة بهم بشكل دوري. سيتم تقييم المستخدمين الحاليين الذين ليس لديهم تاريخ تغيير كلمة مرور مسجل اعتبارًا من تاريخ تفعيل هذه السياسة.',
    enable_password_expiration_tip:
      'لا يمكن تفعيل انتهاء صلاحية كلمة المرور إلا بعد إعداد طريقة واحدة على الأقل لاسترجاع كلمة المرور مع موصل صالح في تجربة تسجيل الدخول.',
    ...
    password_expiration_recovery_reminder:
      'قد لا يكون لدى بعض المستخدمين عنوان بريد إلكتروني أو رقم هاتف لاستلام رمز استرداد كلمة المرور، لذلك لن يتمكنوا من إعادة تعيين كلمة مرور منتهية الصلاحية. اطلب عنوان بريد إلكتروني أو رقم هاتف عند التسجيل للتأكد من أن كل مستخدم يمكنه استرداد كلمة مروره.',
  },
  verification_code_policy: {
    card_title: 'رمز التحقق',
    card_description:
      'قم بتكوين مدة انتهاء الصلاحية والحد الأقصى لمحاولات إعادة المحاولة لرموز التحقق المستخدمة في تدفقات تسجيل الدخول والتسجيل وإعادة تعيين كلمة المرور.',
    enable: {
      title: 'تخصيص إعدادات رمز التحقق',
      description:
        'السماح بتخصيص مدة انتهاء صلاحية رمز التحقق والحد الأقصى لمحاولات إعادة المحاولة.',
    },
    expiration_duration: {
      title: 'مدة انتهاء الصلاحية (بالثواني)',
      description: 'المدة بالثواني التي يبقى خلالها رمز التحقق صالحًا بعد إرساله.',
      error_message: 'يجب أن تكون مدة انتهاء الصلاحية بين 60 و 3600 ثانية.',
    },
    max_retry_attempts: {
      title: 'الحد الأقصى لمحاولات إعادة المحاولة',
      description: 'الحد الأقصى لعدد محاولات التحقق الفاشلة المسموح بها قبل إبطال الرمز.',
  ...
  blocklist: {
    ...
    custom_email_allowlist: {
      ...
      description:
        'أضف قواعد للسماح فقط بنطاقات بريد إلكتروني أو عناوين بريد إلكتروني أو أنماط أحرف بدل محددة للتسجيلات الجديدة وعناوين البريد الإلكتروني المرتبطة حديثًا. أمثلة: bar@example.com، @example.com، foo*@example.com، *@example.com. يتم تجاهل النقاط في عناوين Gmail، لذا يتطابق foo.bar@gmail.com مع foobar@gmail.com.',
      ...
      warnings: {
        identical_entries:
          'توجد بعض إدخالات قائمة السماح أيضًا في قواعد الحظر. قد تظل رسائل البريد الإلكتروني المطابقة محظورة.',
        blocked_exact_email:
          'تطابق بعض عناوين البريد الإلكتروني الدقيقة في قائمة السماح قاعدة حظر. قد تظل رسائل البريد الإلكتروني المطابقة محظورة.',
        blocked_subaddressing:
          'تحتوي بعض إدخالات قائمة السماح على علامة الجمع (+)، لكن عنونة البريد الإلكتروني الفرعية محظورة.',
        effectively_unusable:
          'استنادًا إلى هذه الفحوصات، قد لا تسمح قائمة السماح الحالية بمرور أي بريد إلكتروني جديد.',
      },
    },
    disposable_email: {
    ...
    custom_email_address: {
      ...
      description:
        'أضف قواعد لمنع نطاقات بريد إلكتروني أو عناوين بريد إلكتروني أو أنماط أحرف بدل محددة من التسجيل أو الارتباط عبر واجهة المستخدم. أمثلة: bar@example.com، @example.com، foo*@example.com، *@example.com. يتم تجاهل النقاط في عناوين Gmail، لذا يتطابق foo.bar@gmail.com مع foobar@gmail.com.',
      placeholder: 'أدخل عنوان بريد إلكتروني أو نطاقًا أو نمط أحرف بدل',
      duplicate_error:
