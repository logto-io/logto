const security = {
  ...
  password_policy: {
    ...
    enable_password_expiration_description:
      'اطلب من المستخدمين إعادة تعيين كلمة المرور الخاصة بهم بشكل دوري. سيتم تقييم المستخدمين الحاليين الذين ليس لديهم تاريخ تغيير كلمة مرور مسجل بناءً على تاريخ إنشاء حسابهم.',
    ...
    expiration_reminder: 'تذكير بانتهاء الصلاحية (أيام قبل انتهاء الصلاحية)',
    expiration_reminder_description:
      'عدد الأيام قبل انتهاء الصلاحية لتحذير المستخدمين والمطالبة بإعادة تعيين كلمة المرور. يمكن للمستخدمين تخطي التذكير والمتابعة في تسجيل الدخول.',
    expiration_reminder_error:
      'يجب أن تكون فترة التذكير بانتهاء الصلاحية بين 0 وفترة الصلاحية ({{max}} يومًا).',
  },
  sentinel_policy: {
