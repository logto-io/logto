const mfa = {
  ...
  trusted_device: {
    ...
    description:
      'اسمح للمستخدمين بتخطي تحديات MFA المعتادة على المتصفحات الموثوقة. قد تظل السياسات عالية المخاطر أو التكيفية تتطلب MFA.',
    ...
    duration_error: 'يجب أن يكون الرقم بين {{min}} و {{max}}.',
