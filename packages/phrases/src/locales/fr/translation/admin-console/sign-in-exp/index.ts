...
const sign_in_exp = {
  ...
  branding: {
    ...
    hide_logto_branding_self_hosted_note:
      'Cette fonctionnalité est disponible avec les <selfHosted>plans auto-hébergés</selfHosted>. Elle est également disponible nativement dans <a>Logto Cloud</a>.',
  },
  branding_uploads: {
    app_logo: {
      title: "Logo de l'app",
  ...
  custom_ui: {
    ...
    bring_your_ui_self_hosted_card_description:
      'Téléchargez votre interface de connexion personnalisée avec les <selfHosted>plans auto-hébergés</selfHosted>. Vous pouvez aussi la télécharger directement sur <a>Logto Cloud</a>.',
  ...
  account_center: {
    ...
    custom_css: {
      ...
      description:
        "Personnalisez l'apparence du centre de compte en utilisant du CSS personnalisé.",
    },
  },
  sign_up_and_sign_in,
  content,
