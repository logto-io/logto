const custom_profile_fields = {
  ...
  modal: {
    ...
    avatar: {
      description:
        "Permet aux utilisateurs de téléverser leur photo de profil lors de l'inscription. L'URL de l'image téléversée est enregistrée comme avatar de l'utilisateur.",
  ...
  details: {
    ...
    avatar_upload_description:
      "Les utilisateurs finaux téléversent leur avatar lors de l'inscription. La valeur stockée est l'URL de l'image téléversée.",
  },
};
