const inline_hooks = {
  ...
  result_data: {
    title: 'Résultat du hook',
    subtitle: 'Renvoyez un objet de résultat que Logto comprend pour ce type de hook.',
  },
  environment_variables: {
    ...
    sample_code:
      'Accès aux variables d’environnement dans le gestionnaire de hook inline. Exemple :',
  },
  fetch_external_data: {
    title: 'Récupérer des données externes',
    subtitle: 'Appelez des API externes depuis votre script de hook.',
    description:
      'Utilisez la fonction `fetch` pour appeler vos API externes et inclure les données dans le résultat du hook. Exemple :',
  },
  settings: {
    title: 'Paramètres',
    subtitle:
      'Contrôlez si le hook est actif et la façon dont les erreurs d’exécution sont gérées.',
    enabled: {
      title: 'Activer le hook',
  ...
  security_warning: {
    ...
    description:
      'Les utilisateurs provisionnés par ce hook contournent les protections réservées à l’inscription, y compris la liste de blocage des e-mails, le domaine SSO uniquement, le mode inscription désactivée et les contrôles de profil obligatoire à l’inscription. Les écritures de profil et de mot de passe des utilisateurs existants se produisent aussi avant la fin de la MFA.',
  },
  delete_modal_title: 'Supprimer le hook inline',
  delete_modal_content:
    'Voulez-vous vraiment supprimer ce hook inline ? Le flux d’authentification n’exécutera plus ce script.',
  deleted: 'Hook inline supprimé',
  created: 'Hook inline créé',
  saved: 'Hook inline enregistré',
};
