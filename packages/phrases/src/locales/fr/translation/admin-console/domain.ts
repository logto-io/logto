const domain = {
  ...
  custom: {
    ...
    verification_files: {
      ...
      invalid_path:
        'Utilisez un nom de fichier avec une extension à la racine du domaine, ou un chemin sous /.well-known/. Seuls les lettres, chiffres, points, tirets et traits de soulignement sont pris en charge.',
