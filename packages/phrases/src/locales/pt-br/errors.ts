const errors = {
  ...
  user: {
    username_exists_register: 'O nome de usuário já existe.',
    email_exists_register: 'O endereço de e-mail já existe.',
    phone_exists_register: 'O número de telefone já existe.',
    invalid_email: 'Endereço de e-mail inválido.',
    invalid_phone: 'Número de telefone inválido.',
    email_not_exists: 'O endereço de e-mail ainda não existe.',
    phone_not_exists: 'O número de telefone ainda não existe',
    identity_not_exists: 'A conta social ainda não existe.',
    identity_exists: 'A conta social foi já existe',
    ...
    require_email: 'Você precisa adicionar um endereço de e-mail antes de fazer login.',
    email_exists: 'This email is associated with an existing account.',
    require_sms: 'Este e-mail está associado a uma conta existente.',
    sms_exists: 'Este número de telefone está associado a uma conta existente.',
