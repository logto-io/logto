const sign_in_experiences = {
  ...
  required_mfa_requires_non_skippable_policy:
    'MFA adaptativo e MFA obrigatório exigem uma política de prompt de MFA não ignorável. Use PromptOnlyAtSignInMandatory ou PromptAtSignInAndSignUpMandatory.',
  optional_mfa_requires_skippable_policy:
    'MFA opcional exige uma política de prompt de MFA ignorável. Não use PromptOnlyAtSignInMandatory nem PromptAtSignInAndSignUpMandatory.',
