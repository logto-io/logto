const paywall = {
  ...
  resources:
    'Atingiu o limite de {{count, number}} recursos de API de <planName/>. Atualize o plano para satisfazer as necessidades da sua equipe. <a>Contacte-nos</a> se precisar de assistência.',
  resources_other:
    'Atingiu o limite de {{count, number}} recursos de API de <planName/>. Atualize o plano para satisfazer as necessidades da sua equipe. <a>Contacte-nos</a> se precisar de assistência.',
  scopes_per_resource:
