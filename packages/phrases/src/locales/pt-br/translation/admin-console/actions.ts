const actions = {
  ...
  types: {
    post_first_factor_verification: {
      ...
      description:
        'Execute lógica personalizada após a falha na verificação da senha local durante o login.',
    },
    post_sign_in: {
      name: 'Após o login',
  ...
  result_data: {
    ...
    subtitle: 'Retorne um objeto de resultado que o Logto entenda para este tipo de ação.',
  },
  environment_variables: {
    ...
    sample_code: 'Acessando variáveis de ambiente no manipulador da ação. Exemplo:',
  },
  fetch_external_data: {
    title: 'Buscar dados externos',
    subtitle: 'Chame APIs externas a partir do script da ação.',
    description:
      'Use a função `fetch` para chamar suas APIs externas e incluir os dados no resultado da ação. Exemplo:',
  },
  settings: {
    title: 'Configurações',
    subtitle: 'Controle se a ação está ativa e como os erros de tempo de execução são tratados.',
    enabled: {
      title: 'Ativar ação',
  ...
  sandbox_and_security_warning: {
    ...
    description:
      'No Logto auto-hospedado, este script é executado no mesmo ambiente que o próprio Logto: ele pode ler variáveis de ambiente do servidor e acessar serviços na sua rede interna. Não está em sandbox. Conceda acesso a esta página apenas a pessoas em quem você confiaria o acesso ao servidor. Esta ação é executada somente após a falha na verificação da senha local — retorne `passwordVerified: true` somente depois de verificar de forma independente a senha enviada. Usuários provisionados por esta ação ignoram proteções exclusivas do registro, incluindo blocklist de e-mail, domínio apenas SSO, modo de cadastro desativado e verificações de perfil obrigatório no registro. Gravações de perfil e senha de usuários existentes também ocorrem antes da conclusão da MFA.',
  },
  sandbox_warning: {
    title: 'Os scripts são executados com privilégios do servidor',
    description:
  ...
  security_warning: {
    ...
    description:
      'Esta ação é executada somente após a falha na verificação da senha local. Retorne `passwordVerified: true` somente depois de verificar de forma independente a senha enviada. Usuários provisionados por esta ação ignoram proteções exclusivas do registro, incluindo blocklist de e-mail, domínio apenas SSO, modo de cadastro desativado e verificações de perfil obrigatório no registro. Gravações de perfil e senha de usuários existentes também ocorrem antes da conclusão da MFA.',
  },
  delete_modal_title: 'Excluir ação',
  delete_modal_content:
    'Tem certeza de que deseja excluir esta ação? O fluxo de autenticação não executará mais este script.',
  deleted: 'Ação excluída',
  created: 'Ação criada',
  saved: 'Ação salva',
};
