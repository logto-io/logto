...
const sign_in_exp = {
  ...
  branding: {
    ...
    hide_logto_branding_self_hosted_note:
      'Este recurso está disponível com os <selfHosted>planos self-hosted</selfHosted>. Também está disponível nativamente no <a>Logto Cloud</a>.',
  },
  branding_uploads: {
    app_logo: {
  ...
  custom_ui: {
    ...
    bring_your_ui_self_hosted_card_description:
      'Envie sua interface de login personalizada com os <selfHosted>planos self-hosted</selfHosted>. Você também pode enviá-la diretamente para o <a>Logto Cloud</a>.',
