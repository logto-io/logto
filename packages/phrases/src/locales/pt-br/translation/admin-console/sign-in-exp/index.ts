...
const sign_in_exp = {
  ...
  account_center: {
    ...
    enable_account_api_description:
      'Ativa tanto a Account API voltada ao usuário final quanto o centro de conta pronto para uso da Logto. Quando desativado, ambos os recursos ficam indisponíveis.',
    field_options: {
      off: 'Desativado',
      edit: 'Editar',
    ...
    prebuilt_ui: {
      ...
      account_center_description:
        'Direcione os usuários para o portal completo de gerenciamento de contas com todos os recursos.',
      ...
      tooltips: {
        ...
        account_center:
          'Acesse o portal completo de gerenciamento de contas com todas as configurações de segurança',
      },
