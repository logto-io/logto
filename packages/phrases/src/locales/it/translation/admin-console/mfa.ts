const mfa = {
  ...
  adaptive_mfa: 'MFA adattiva',
  adaptive_mfa_label:
    'Attiva MFA solo quando vengono rilevati segnali di rischio. La MFA obbligatoria sostituisce questa impostazione. Richiede almeno un fattore MFA.',
