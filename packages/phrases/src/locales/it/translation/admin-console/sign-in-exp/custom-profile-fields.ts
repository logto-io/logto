const custom_profile_fields = {
  ...
  details: {
    ...
    date_format_us: 'Stati Uniti (MM/gg/aaaa)',
    date_format_uk: 'Regno Unito e Europa (gg/MM/aaaa)',
    date_format_iso: 'Standard internazionale (aaaa-MM-gg)',
    custom_date_format: 'Formato data personalizzato',
    custom_date_format_placeholder: 'Inserisci il formato data personalizzato. Es. "MM-gg-aaaa"',
