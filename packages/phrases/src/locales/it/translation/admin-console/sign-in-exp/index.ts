...
const sign_in_exp = {
  ...
  account_center: {
    ...
    enable_account_api_description:
      'Abilita insieme l’Account API per gli utenti finali e il centro account pronto all’uso di Logto. Se disattivato, entrambe le funzionalità non sono disponibili.',
    field_options: {
      off: 'Disattivato',
      edit: 'Modifica',
