...
const errors = {
  ...
  connector: {
    ...
    insufficient_request_parameters: 'The request might missed some input parameters.',
    ...
    auth_code_invalid: "Connector's auth code is invalid.",
    access_token_invalid: "Connector's access token is invalid.",
    id_token_invalid: "Connector's id token is invalid.",
