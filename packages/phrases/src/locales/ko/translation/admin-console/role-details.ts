const role_details = {
  ...
  applications: {
    assign_button: '머신 투 머신 앱 할당',
    name_column: '앱',
    app_column: '머신 투 머신 앱',
    description_column: '설명',
    delete_description: '이 앱은 앱 모음에 남아 있지만 이 역할에 대한 권한을 상실하게 됩니다.',
    deleted: '{{name}} 이(가) 이 역할에서 성공적으로 제거되었습니다.',
    assign_title: '{{name}} 에 머신 투 머신 앱 할당',
    assign_subtitle: '이름, 설명 또는 앱 ID로 검색하여 적절한 머신 투 머신 앱을 찾습니다.',
    assign_field: '머신 투 머신 앱 할당',
    confirm_assign: '머신 투 머신 앱 할당',
