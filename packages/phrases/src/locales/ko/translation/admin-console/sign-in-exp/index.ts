...
const sign_in_exp = {
  ...
  branding: {
    ...
    hide_logto_branding_self_hosted_note:
      '이 기능은 <selfHosted>셀프 호스팅 플랜</selfHosted>에서 사용할 수 있습니다. <a>Logto Cloud</a>에서도 기본 제공됩니다.',
  },
  branding_uploads: {
    app_logo: {
      title: '앱 로고',
  ...
  custom_ui: {
    ...
    bring_your_ui_self_hosted_card_description:
      '사용자 지정 로그인 UI를 <selfHosted>셀프 호스팅 플랜</selfHosted>으로 업로드하세요. <a>Logto Cloud</a>에 직접 업로드할 수도 있습니다.',
  ...
  account_center: {
    ...
    profile_fields: {
      ...
      disabled_hint: {
        name: "이 필드를 추가하려면 먼저 아래의 사용자 프로필 섹션에서 '이름' 권한을 '편집/읽기 전용'으로 설정하세요.",
        avatar:
          "이 필드를 추가하려면 먼저 아래의 사용자 프로필 섹션에서 '아바타' 권한을 '편집/읽기 전용'으로 설정하세요.",
        profile:
          "이 필드를 추가하려면 먼저 아래의 사용자 프로필 섹션에서 '프로필' 권한을 '편집/읽기 전용'으로 설정하세요.",
        custom_data:
          "이 필드를 추가하려면 먼저 아래의 사용자 프로필 섹션에서 '사용자 정의 데이터' 권한을 '편집/읽기 전용'으로 설정하세요.",
      },
    },
