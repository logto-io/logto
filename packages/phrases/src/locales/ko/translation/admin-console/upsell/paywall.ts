const paywall = {
  ...
  saml_applications_oss_limit_notice_self_hosted:
    '오픈 소스 인스턴스는 최대 {{limit}}개의 SAML 애플리케이션을 지원합니다. 셀프 호스팅 플랜으로 더 많은 SAML 앱을 잠금 해제하거나 Logto Cloud를 사용하세요.',
  ...
  branding_customization:
    '플랜을 업그레이드하여 "Logto 브랜딩 숨기기"과 "UI 가져오기" 기능으로 브랜드를 완전히 제어하세요.',
