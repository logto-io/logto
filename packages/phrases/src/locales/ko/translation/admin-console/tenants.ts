const tenants = {
  ...
  settings: {
    title: '설정',
    description: '테넌트 이름을 설정하고 데이터 호스팅 지역 및 테넌트 유형을 확인하세요.',
    tenant_id: '테넌트 ID',
    tenant_name: '테넌트 이름',
    ...
    development_description:
      '테스트 전용이며 프로덕션에서 사용해선 안 됩니다. 구독이 필요하지 않습니다. 사인 인 배너와 같은 제한 사항은 있지만 모든 프로 특징을 제공합니다. <a>자세히 알아보기</a>',
    production_description:
      '최종 사용자에 의해 사용되는 앱을 위해 의도되었으며 유료 구독이 필요할 수 있습니다. <a>자세히 알아보기</a>',
  ...
  create_modal: {
    ...
    development_description:
      '테스트 전용이며 프로덕션에서 사용해선 안 됩니다. 구독이 필요하지 않습니다.',
    development_hint: '사인 인 배너와 같은 제한 사항은 있지만 모든 프로 특징을 제공합니다.',
    production_description:
      '최종 사용자에 의해 사용되는 앱을 위해 의도되었으며 유료 구독이 필요할 수 있습니다.',
    available_plan: '사용 가능한 요금제:',
    create_button: '테넌트 만들기',
    tenant_name_placeholder: '내 테넌트',
  },
  dev_tenant_migration: {
    title: '새로운 "개발 테넌트"를 만들어 호비 및 프로 기능을 무료로 이용해볼 수 있습니다!',
    affect_title: '이것이 당신에게 미치는 영향',
    hint_1:
      '이전 <strong>환경 태그</strong>를 두 가지 새 테넌트 유형인 <strong>“개발”</strong>과 <strong>“프로드”</strong>으로 대체하고 있습니다.',
    hint_2:
      '원활한 전환과 기능의 연속성을 위해 이전에 만든 테넌트는 모두 이전 구독을 포함하여 <strong>프로드</strong> 테넌트 유형으로 승격됩니다.',
    hint_3: '걱정 마세요. 다른 설정은 그대로 유지됩니다.',
    about_tenant_type: '테넌트 유형 정보',
  },
  dev_tenant_notification: {
    title: '개발 테넌트에서 <a>Logto Hobby 및 Pro의 모든 기능</a>을 이제 이용하실 수 있습니다!',
    description: '이것은 완전 무료이며 시험 기간이 없습니다 – 영원히!',
  },
  delete_modal: {
    title: '테넌트 삭제',
    description_line1:
