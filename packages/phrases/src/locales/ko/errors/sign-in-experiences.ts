const sign_in_experiences = {
  ...
  required_mfa_requires_non_skippable_policy:
    '적응형 MFA와 필수 MFA에는 건너뛸 수 없는 MFA 프롬프트 정책이 필요합니다. PromptOnlyAtSignInMandatory 또는 PromptAtSignInAndSignUpMandatory를 사용하세요.',
  optional_mfa_requires_skippable_policy:
    '선택적 MFA에는 건너뛸 수 있는 MFA 프롬프트 정책이 필요합니다. PromptOnlyAtSignInMandatory 또는 PromptAtSignInAndSignUpMandatory를 사용하지 마세요.',
