const cloud = {
  console_sso: {
    ...
    domain_verify_step: 'Verifique o seu domínio',
    domain_bind_step: 'Associar domínio de e-mail',
    ...
    domain_binding_pending: 'A associação começa automaticamente após a verificação.',
