const session = {
  ...
  step_up: {
    ...
    forbidden_route: 'Yükseltilmiş kimlik doğrulama sırasında bu rotaya izin verilmez.',
    require_verification:
      'İstenen kimlik doğrulama bağlamını karşılamak için ek doğrulama gereklidir.',
  },
  passkey_sign_in: {
