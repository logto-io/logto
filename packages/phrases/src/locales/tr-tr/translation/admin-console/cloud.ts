const cloud = {
  ...
  congrats: {
    ...
    description:
      'Don’t miss out on a chance to enjoy a free <strong>3-month</strong> subscription to Logto Cloud after its official launch! Contact the Logto team now to learn more.', // UNTRANSLATED
