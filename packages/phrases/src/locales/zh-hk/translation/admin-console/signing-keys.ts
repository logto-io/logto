const signing_keys = {
  ...
  rotate_cookie_keys: '輪換 Cookie 金鑰',
  rotate_private_keys_description:
    '此操作將創建一個新的私密簽署金鑰，輪換當前金鑰並刪除以前的金鑰。您的使用當前金鑰簽署的 JWT 標記將保持有效，直到刪除或再次輪換。',
  rotate_cookie_keys_description:
    '此操作將創建一個新的 cookie 金鑰，輪換當前金鑰並刪除以前的金鑰。使用當前金鑰簽署的 cookie 將保持有效，直到刪除或再次輪換。',
  ...
  reminder: {
    rotate_private_key:
      '您確定要輪換<strong>OIDC私密金鑰</strong>嗎？使用新金鑰發放的 JWT 標記將由新金鑰簽署。使用當前金鑰簽署的 JWT 標記將保持有效，直到您再次輪換。',
    rotate_cookie_key:
      '您確定要輪換<strong>OIDC Cookie金鑰</strong>嗎？在登錄會話中生成的新 cookie 將由新cookie金鑰簽署。使用當前金鑰簽署的cookie將保持有效，直到您再次輪換。',
    delete_private_key:
