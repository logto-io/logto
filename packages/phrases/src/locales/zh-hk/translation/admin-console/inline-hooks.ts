const inline_hooks = {
  ...
  result_data: {
    title: '鉤子結果',
    subtitle: '返回 Logto 可理解的結果物件，以適配此鉤子類型。',
  },
  environment_variables: {
    title: '設定環境變數',
    subtitle: '使用環境變數儲存敏感資訊。',
    input_field_title: '新增環境變數',
    sample_code: '在內聯鉤子處理程序中存取環境變數。示例：',
  },
  fetch_external_data: {
    title: '取得外部數據',
    subtitle: '在鉤子腳本中呼叫外部 API。',
    description: '使用 `fetch` 函數呼叫外部 API，並將數據包含在鉤子結果中。示例：',
  },
  settings: {
    title: '設定',
    subtitle: '控制鉤子是否啟用，以及運行時錯誤的處理方式。',
    enabled: {
      title: '啟用鉤子',
  ...
  security_warning: {
    title: '安全警告',
    description:
      '透過此鉤子建立的用戶會繞過僅適用於註冊的限制，包括電郵黑名單、僅 SSO 網域、停用註冊模式，以及註冊必填資料檢查。對現有用戶的資料和密碼寫入也會在 MFA 完成前發生。',
  },
  delete_modal_title: '刪除內聯鉤子',
  delete_modal_content: '確定要刪除此內聯鉤子嗎？身份驗證流程將不再運行此腳本。',
  deleted: '內聯鉤子已刪除',
  created: '內聯鉤子已建立',
  saved: '內聯鉤子已儲存',
};
