  ...
  others: {
    ...
    authentication: {
      ...
      disallow_forgot_password_description:
        'Your identifiers can’t be verified due to the current settings. Enable email or phone in sign up or select verification code in sign in to enable forget password.',
    },
  },
  setup_warning: {
    no_connector: '',
