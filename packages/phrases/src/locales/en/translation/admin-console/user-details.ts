const user_details = {
  ...
  roles: {
    ...
    assign_button: 'Assign user roles',
    delete_description:
    ...
    assign_title: 'Assign user roles to {{name}}',
    ...
    confirm_assign: 'Assign user roles',
    role_assigned: 'Successfully assigned role(s)',
    search: 'Search by role name, description or ID',
    empty: 'No role available',
    create_user_role_hint: "Can't find the right user role? <a>Create a user role</a>",
  },
