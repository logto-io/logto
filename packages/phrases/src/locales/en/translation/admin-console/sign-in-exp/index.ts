...
const sign_in_exp = {
  ...
  branding: {
    ...
    hide_logto_branding_self_hosted_note:
      'This feature is available with <selfHosted>self-hosted plans</selfHosted>. It is also natively available in <a>Logto Cloud</a>.',
  },
  branding_uploads: {
    app_logo: {
      title: 'App logo',
  ...
  custom_ui: {
    ...
    bring_your_ui_self_hosted_card_description:
      'Upload your custom sign-in UI with <selfHosted>self-hosted plans</selfHosted>. You can also upload it directly on <a>Logto Cloud</a>.',
