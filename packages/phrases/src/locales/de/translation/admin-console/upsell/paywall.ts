const paywall = {
  ...
  saml_applications_oss_limit_notice_self_hosted:
    'Ihre Open-Source-Instanz unterstützt bis zu {{limit}} SAML-Anwendungen. Schalten Sie weitere SAML-Apps mit Self-Hosted-Plänen frei, oder nutzen Sie Logto Cloud.',
