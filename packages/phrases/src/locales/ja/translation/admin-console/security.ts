const security = {
  ...
  blocklist: {
    ...
    custom_email_allowlist: {
      ...
      description:
        '新規登録および新しくリンクされるメールに対して、特定のメールドメイン、メールアドレス、またはワイルドカードパターンのみを許可するルールを追加します。例：bar@example.com、@example.com、foo*@example.com、*@example.com。Gmail アドレスのドットは無視されるため、foo.bar@gmail.com は foobar@gmail.com と一致します。',
    ...
    custom_email_address: {
      ...
      description:
        '特定のメールドメイン、メールアドレス、またはワイルドカードパターンが UI を介して登録またはリンクできないようにするルールを追加します。例：bar@example.com、@example.com、foo*@example.com、*@example.com。Gmail アドレスのドットは無視されるため、foo.bar@gmail.com は foobar@gmail.com と一致します。',
      placeholder: 'メールアドレス、ドメイン、またはワイルドカードパターンを入力',
      duplicate_error:
        'メールアドレス、ドメイン、またはワイルドカード付きメールアドレスパターンは既に追加されています',
      invalid_format_error:
