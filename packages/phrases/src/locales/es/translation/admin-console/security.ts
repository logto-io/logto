const security = {
  ...
  blocklist: {
    ...
    email_subaddressing: {
      ...
      description:
        'Habilita para evitar que los usuarios utilicen subdirecciones de correo electrónico con un signo más (+) y caracteres adicionales (por ejemplo, usuario+alias@foo.com).',
    },
