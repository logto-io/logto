const session = {
  ...
  step_up: {
    ...
    forbidden_identifier:
      'Указывать идентификатор при повышении уровня аутентификации нельзя. Повторите попытку без поля идентификатора.',
    acr_not_satisfied:
      'Завершенная проверка не соответствует запрошенному контексту аутентификации. Проверьте другой способ.',
    require_verification:
      'Чтобы достичь запрошенного контекста аутентификации, необходимо пройти проверку одним из ваших существующих способов.',
  },
  passkey_sign_in: {
    pending_info_not_found:
