const session = {
  ...
  trusted_device_suggest_opt_in: 'Выберите, следует ли доверять этому устройству.',
  step_up: {
    invalid_interaction_event:
      'Повышение уровня аутентификации доступно только для взаимодействий входа.',
    subject_not_found:
      'Аутентифицированная сессия для повышения уровня аутентификации не найдена. Пожалуйста, войдите снова.',
    forbidden_route: 'Этот маршрут не разрешен во время повышения уровня аутентификации.',
    require_verification:
      'Требуется дополнительная проверка для соответствия запрошенному контексту аутентификации.',
  },
  passkey_sign_in: {
    pending_info_not_found:
  ...
  password_expiration: {
    reset_not_allowed:
      'Сброс пароля разрешен только после истечения срока действия пароля в текущей сессии входа.',
  },
  sso_enabled:
