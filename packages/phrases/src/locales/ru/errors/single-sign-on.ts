const single_sign_on = {
  ...
  can_not_delete_active_signing_key:
    'Невозможно удалить активный ключ подписи. Сначала активируйте другой ключ или деактивируйте этот ключ.',
  can_not_deactivate_signing_key_in_use:
    'Невозможно деактивировать ключ подписи, пока включены подписанные запросы аутентификации. Сначала отключите подписанные запросы аутентификации.',
  active_signing_key_required:
    'Активный ключ подписи не найден. Создайте и активируйте ключ подписи перед включением подписанных запросов аутентификации.',
};
