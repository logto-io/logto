const applications = {
  ...
  guide: {
    third_party: {
      ...
      description:
        'Используйте Logto в качестве поставщика удостоверений, чтобы предоставить OAuth-авторизацию сторонним сервисам. Включает предустановленный экран согласия пользователя для безопасного доступа к ресурсам.',
    },
  },
};
