const mfa = {
  ...
  adaptive_mfa: 'Адаптивная MFA',
  adaptive_mfa_label:
    'Запускайте MFA только при обнаружении сигналов риска. Обязательная MFA переопределяет эту настройку. Требуется как минимум один фактор MFA.',
