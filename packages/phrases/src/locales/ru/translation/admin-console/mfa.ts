const mfa = {
  ...
  trusted_device: {
    ...
    description:
      'Разрешите пропускать обычные проверки MFA в доверенных браузерах. Политики высокого риска или адаптивные политики по-прежнему могут требовать MFA.',
    ...
    duration_error: 'Число должно быть от {{min}} до {{max}}.',
