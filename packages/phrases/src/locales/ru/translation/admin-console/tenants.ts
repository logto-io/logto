const tenants = {
  ...
  oss_description:
    'Измените настройки учетной записи и управляйте личной информацией здесь, чтобы обеспечить безопасность вашей учетной записи.',
  tabs: {
    settings: 'Настройки',
    members: 'Участники',
    domains: 'Домены',
  ...
  members: {
    ...
    self_hosted_card_title: 'Управляйте арендаторами безопаснее с self-hosted планами',
    self_hosted_card_description:
      'Добавляйте администраторов или участников в своего арендатора без совместного использования одной учетной записи администратора.',
    self_hosted_card_action: 'Открыть self-hosted планы',
  },
  settings: {
    title: 'НАСТРОЙКИ',
    description:
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'Настройте идентификатор арендатора. Если оставить пустым, Logto сгенерирует идентификатор по умолчанию. Идентификатор арендатора нельзя изменить после создания.',
  },
