...
const sign_in_exp = {
  ...
  branding: {
    ...
    hide_logto_branding_self_hosted_note:
      'Эта функция доступна с <selfHosted>self-hosted планами</selfHosted>. Она также нативно доступна в <a>Logto Cloud</a>.',
  },
  branding_uploads: {
    app_logo: {
  ...
  custom_ui: {
    ...
    css_code_editor_field_title: 'Переопределение CSS',
    ...
    css_code_editor_content_placeholder:
      'Введите здесь свои переопределения CSS, чтобы точно настроить стили любых элементов под ваши требования. Проявите креативность и выделите свой UI.',
    bring_your_ui_title: 'Создайте свой интерфейс',
    bring_your_ui_upload_title: 'Загрузить пользовательские ресурсы UI',
    ...
    bring_your_ui_self_hosted_card_description:
      'Загрузите свой пользовательский интерфейс входа с <selfHosted>self-hosted планами</selfHosted>. Вы также можете загрузить его прямо в <a>Logto Cloud</a>.',
    ...
    csp_description:
      'Разрешите дополнительные выражения источников для пользовательского интерфейса входа. Эти значения применяются только при обслуживании пользовательских ресурсов UI.',
    csp_script_src: 'Разрешённые script-src',
    csp_script_src_tip:
      'Разрешите выражения источников HTTPS для скриптов, загружаемых вашим пользовательским UI, например https://scripts.example.com или https://*.example.com.',
    csp_connect_src: 'Разрешённые connect-src',
    csp_connect_src_tip:
      'Разрешите выражения источников HTTPS или WSS для сетевых запросов вашего пользовательского UI, например https://api.example.com или wss://events.example.com.',
    csp_source_invalid_error:
      'Введите допустимое выражение источника. Используйте URL с https://; connect-src также поддерживает wss://. Ключевые слова CSP и точки с запятой не поддерживаются.',
    csp_source_duplicate_error: 'Это выражение источника уже есть в списке.',
  },
  account_center: {
    ...
    profile_fields: {
      ...
      disabled_hint: {
        name: 'Чтобы добавить это поле, сначала установите разрешение «Имя» в значение «Редактировать/Только чтение» в разделе «Профиль пользователя» ниже.',
        avatar:
          'Чтобы добавить это поле, сначала установите разрешение «Аватар» в значение «Редактировать/Только чтение» в разделе «Профиль пользователя» ниже.',
        profile:
          'Чтобы добавить это поле, сначала установите разрешение «Профиль» в значение «Редактировать/Только чтение» в разделе «Профиль пользователя» ниже.',
        custom_data:
          'Чтобы добавить это поле, сначала установите разрешение «Пользовательские данные» в значение «Редактировать/Только чтение» в разделе «Профиль пользователя» ниже.',
      },
    },
    ...
    prebuilt_ui: {
      ...
      description:
        'Быстро интегрируйте готовый центр аккаунта, проверку безопасности или единичный поток обновления профиля с готовым интерфейсом. Просто объедините ваш домен с маршрутом, чтобы сформировать URL центра аккаунта (например, https://auth.foo.com/account/email).',
      permission_notice:
      ...
      account_center_title: 'Интегрируйте готовый центр аккаунта',
      account_center_description:
        'Направляйте пользователей в центр аккаунта для управления настройками безопасности, такими как электронная почта, телефон, имя пользователя, пароль, MFA и подключённые аккаунты.',
      flows_title: 'Интегрируйте готовые потоки настройки безопасности',
      single_task_flows_title: 'Интегрируйте готовый поток для одной задачи',
      flows_description:
        'Объедините ваш домен с маршрутом, чтобы сформировать URL настроек аккаунта (например, https://auth.foo.com/account/email). При желании добавьте `redirect=` для возврата пользователей в ваше приложение после успешного обновления, `show_success=true` для отображения страницы успеха, `ui_locales=` для переопределения языка по умолчанию, или `identifier=` для предварительного заполнения поля ввода идентификатора.',
      single_task_flows_description:
        'Направляйте пользователей сразу в определённый поток (например, привязка email). При желании добавьте `redirect=` для возврата пользователей в ваше приложение после успешного обновления, `show_success=true` для отображения страницы успеха, `ui_locales=` для переопределения языка по умолчанию, или `identifier=` для предварительного заполнения поля ввода идентификатора.',
      tooltips: {
        ...
        social_change: 'Переключитесь на другой подключенный социальный аккаунт',
        ...
        account_center:
          'Откройте центр аккаунта для управления настройками безопасности, такими как электронная почта, телефон, имя пользователя, пароль, MFA и подключённые аккаунты',
        profile: 'Центральный узел для управления вашей личной информацией (например, имя, аватар)',
        sessions: 'Просмотр и управление активными сеансами на всех устройствах',
      },
