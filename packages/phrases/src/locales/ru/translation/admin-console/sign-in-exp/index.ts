...
const sign_in_exp = {
  ...
  account_center: {
    ...
    enable_account_api_description:
      'Одновременно включает Account API для конечных пользователей и готовый к использованию центр учётной записи Logto. При отключении обе функции недоступны.',
    field_options: {
      off: 'Выключено',
      edit: 'Редактировать',
    ...
    prebuilt_ui: {
      ...
      account_center_description:
        'Направляйте пользователей в полноценный портал управления аккаунтом со всеми функциями.',
      ...
      tooltips: {
        ...
        account_center:
          'Откройте полноценный портал управления аккаунтом со всеми настройками безопасности',
      },
