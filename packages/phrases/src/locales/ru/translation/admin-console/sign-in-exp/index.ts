...
const sign_in_exp = {
  ...
  account_center: {
    ...
    profile_fields: {
      ...
      disabled_hint: {
        name: 'Чтобы добавить это поле, сначала установите разрешение «Имя» в значение «Редактировать/Только чтение» в разделе «Данные профиля» выше.',
        avatar:
          'Чтобы добавить это поле, сначала установите разрешение «Аватар» в значение «Редактировать/Только чтение» в разделе «Данные профиля» выше.',
        profile:
          'Чтобы добавить это поле, сначала установите разрешение «Профиль» в значение «Редактировать/Только чтение» в разделе «Данные профиля» выше.',
        custom_data:
          'Чтобы добавить это поле, сначала установите разрешение «Пользовательские данные» в значение «Редактировать/Только чтение» в разделе «Данные профиля» выше.',
      },
    },
