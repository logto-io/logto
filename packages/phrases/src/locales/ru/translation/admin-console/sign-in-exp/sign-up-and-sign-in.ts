const sign_up_and_sign_in = {
  ...
  username_policy: {
    title: 'Политика имени пользователя',
    description:
      'Настройте требования к имени пользователя, включая длину, разрешённые символы и чувствительность к регистру.',
    manage_button: 'Управлять',
    modal_title: 'Политика имени пользователя',
    modal_description:
      'Настройте требования к имени пользователя для ваших конечных пользователей.',
    length: {
      title: 'Длина имени пользователя',
      minimum: 'Минимум',
      maximum: 'Максимум',
      min_greater_than_max: 'Минимальная длина не может превышать максимальную длину.',
    },
    allowed_chars: {
      title: 'Разрешённые типы символов',
      uppercase: 'Прописные буквы (A-Z)',
      lowercase: 'Строчные буквы (a-z)',
      numbers: 'Цифры (0-9)',
      underscore: 'Подчёркивания (_)',
      no_valid_leading_char:
        'Использование только цифр не допускается. Включите хотя бы один из вариантов: прописные буквы, строчные буквы или подчёркивания.',
      no_char_selected: 'Выберите хотя бы один тип символов.',
    },
    case_sensitive: {
      title: 'Имена пользователей с учётом регистра',
      description:
        'Рассматривать прописные и строчные буквы как разные. «user123» и «User123» считаются разными именами пользователей.',
    },
    case_conflicts: {
      title: 'Обнаружены существующие конфликты имён пользователей',
      description:
        'Некоторые имена пользователей будут конфликтовать, если отключить учёт регистра. Прежде чем сохранить, устраните {{count}} конфликтующих групп ниже.',
      sample_title: 'Конфликтующие имена пользователей',
    },
  },
};
