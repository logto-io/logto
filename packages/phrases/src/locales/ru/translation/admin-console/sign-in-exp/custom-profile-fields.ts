const custom_profile_fields = {
  ...
  modal: {
    ...
    avatar: {
      description:
        'Позволяет пользователям загружать и обрезать фото профиля при регистрации. URL загруженного изображения сохраняется как avatar пользователя.',
      storage_not_configured:
        'Загрузка avatar требует настроенного провайдера хранилища. Настройте storage перед добавлением этого поля.',
    },
  },
  details: {
    ...
    avatar_upload_description:
      'Конечные пользователи загружают и обрезают avatar при регистрации. Сохраняемое значение — URL загруженного изображения.',
  },
};
