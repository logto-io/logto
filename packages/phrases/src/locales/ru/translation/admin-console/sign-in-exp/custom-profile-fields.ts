const custom_profile_fields = {
  ...
  modal: {
    ...
    avatar: {
      description:
        'Позволяет пользователям загружать фото профиля при регистрации. URL загруженного изображения сохраняется как avatar пользователя.',
  ...
  details: {
    ...
    avatar_upload_description:
      'Конечные пользователи загружают avatar при регистрации. Сохраняемое значение — URL загруженного изображения.',
  },
};
