const custom_profile_fields = {
  ...
  details: {
    ...
    composition_parts: 'Составные части',
    composition_parts_tip: 'Выберите части для составления сложного поля.',
    ...
    date_format_us: 'США (MM/дд/гггг)',
    date_format_uk: 'Великобритания и Европа (дд/MM/гггг)',
    date_format_iso: 'Международный стандарт (гггг-MM-дд)',
    custom_date_format: 'Пользовательский формат даты',
    custom_date_format_placeholder: 'Введите пользовательский формат даты. Например, "MM-дд-гггг"',
