const paywall = {
  ...
  saml_applications_oss_limit_notice:
    'Вы достигли OSS-лимита в {{limit}} SAML-приложений. Подпишитесь на Logto Cloud, чтобы разблокировать больше SAML-приложений.',
  ...
  branding_customization:
    'Обновите свой план, чтобы получить полный контроль над брендингом с функциями "Скрыть брендинг Logto" и "Создайте свой интерфейс".',
  bring_your_ui:
