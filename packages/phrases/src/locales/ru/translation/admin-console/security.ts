const security = {
  ...
  blocklist: {
    ...
    custom_email_allowlist: {
      ...
      description:
        'Разрешайте только совпадающие адреса электронной почты, домены или шаблоны с подстановочными символами для новых регистраций и новых привязанных адресов.',
      placeholder:
        'Введите разрешенный адрес электронной почты, домен или шаблон с подстановочным символом (например, bar@example.com, @example.com, foo*@example.com, *@example.com)',
      duplicate_error:
    ...
    custom_email_address: {
      ...
      description:
        'Добавьте правила, чтобы блокировать регистрацию или связывание через пользовательский интерфейс для конкретных доменов электронной почты, адресов или шаблонов адресов с подстановочными знаками.',
      placeholder:
        'Введите заблокированный адрес электронной почты, домен или шаблон адреса с подстановочным знаком (например, bar@example.com, @example.com, foo*@example.com, *@example.com)',
      duplicate_error:
