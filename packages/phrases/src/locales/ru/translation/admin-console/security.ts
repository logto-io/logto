const security = {
  ...
  blocklist: {
    ...
    custom_email_address: {
      ...
      description:
        'Добавьте правила, запрещающие определённым доменам, адресам электронной почты или шаблонам с подстановочными символами регистрироваться или связываться через пользовательский интерфейс. Примеры: bar@example.com, @example.com, foo*@example.com, *@example.com. Точки в адресах Gmail игнорируются, поэтому foo.bar@gmail.com соответствует foobar@gmail.com.',
      placeholder: 'Введите адрес электронной почты, домен или шаблон с подстановочным символом',
      duplicate_error:
