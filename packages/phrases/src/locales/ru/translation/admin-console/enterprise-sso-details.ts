const enterprise_sso_details = {
  ...
  trust_unverified_email_tip_oidc:
    'Коннектор OIDC может не возвращать утверждение `email_verified`, что означает, что адреса электронной почты от IdP не гарантированно проверены. По умолчанию Logto не синхронизирует неподтвержденные адреса электронной почты с профилем пользователя. Включайте эту опцию только если вы доверяете всем адресам электронной почты от IdP.',
  offline_access: {
