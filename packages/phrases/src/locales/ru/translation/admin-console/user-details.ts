const user_details = {
  ...
  roles: {
    ...
    assign_button: 'Назначить роли пользователя',
    delete_description:
    ...
    assign_title: 'Назначить роли пользователя для {{name}}',
    assign_subtitle:
    ...
    confirm_assign: 'Назначить роли пользователя',
    ...
    create_user_role_hint:
      'Не можете найти подходящую роль пользователя? <a>Создать роль пользователя</a>',
  },
