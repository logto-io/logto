const user_details = {
  ...
  expire_password: {
    button: 'Сделать истекшим',
    title: 'Вы уверены, что хотите сделать этот пароль истекшим?',
    content:
      'Пользователю потребуется сбросить пароль при следующем входе в систему. Это действие нельзя отменить.',
    success: 'Пароль пользователя был помечен как истекший.',
    not_enabled_tooltip: 'Политика истечения срока действия пароля не включена.',
  },
  ...
  sessions: {
    title: 'Сессии',
    description:
      'Управление сессиями, поддерживаемыми сервером авторизации Logto. Приостановка сессии Logto здесь предотвращает автоматическое согласие на будущие запросы авторизации.',
    field_name: 'Сессии',
  ...
  third_party_apps: {
    ...
    description:
      'Используйте Logto как поставщика удостоверений для авторизации сторонних приложений. Просматривайте и управляйте приложениями, которым этот пользователь предоставил доступ.',
    field_name: 'Авторизованные сторонние приложения',
    multiple_authorized: 'Этот пользователь авторизовал несколько сторонних приложений и сервисов.',
    not_authorized:
      'Этот пользователь пока не авторизовал ни одно стороннее приложение или сервис.',
    name_column: 'Название',
    app_id_column: 'ID приложения',
    access_created_at_column: 'Доступ создан',
    revoke_access_title: 'Отозвать доступ?',
    revoke_access_description:
      'Это отзовет доступ приложения к учетной записи пользователя на всех устройствах. Пользователю потребуется повторно авторизовать приложение, чтобы восстановить доступ. Ранее выданные токены доступа могут оставаться действительными до истечения срока их действия.',
  },
  connections: {
    title: 'Подключение',
    description:
