const user_details = {
  ...
  personal_access_tokens: {
    ...
    tip: 'Персональные токены доступа (PATs) обеспечивают безопасный способ предоставления пользователями токенов доступа без использования своих учетных данных и интерактивного входа. Это полезно для CI/CD, скриптов или приложений, которым необходимо программно получать доступ к ресурсам. <a>Узнать больше</a>',
    value: 'Значение',
    created_at: 'Создан',
