const user_details = {
  ...
  third_party_apps: {
    ...
    revoke_access_description:
      'Это отзовет доступ приложения к учетной записи пользователя на всех устройствах. Пользователю потребуется повторно авторизовать приложение, чтобы восстановить доступ.',
  },
  connections: {
    title: 'Подключение',
    description:
