const domain = {
  ...
  custom: {
    ...
    verification_files: {
      title: 'Файлы проверки домена',
      description:
        'Размещайте небольшие текстовые или JSON-файлы на этом пользовательском домене, чтобы подтверждать владение доменом в сторонних сервисах.',
      add: 'Добавить файл проверки',
      empty: 'Файлы проверки не настроены.',
      path: 'Путь к файлу',
      content_type: 'Тип содержимого',
      content_type_text: 'Обычный текст',
      content_type_json: 'JSON',
      content: 'Содержимое файла',
      content_placeholder: 'Вставьте точное содержимое файла проверки',
      required: 'Это поле обязательно.',
      invalid_path:
        'Используйте имя файла с расширением в корне домена или путь в /.well-known/. Поддерживаются только буквы, цифры, точки, дефисы и символы подчёркивания.',
      duplicate_path: 'Файл проверки с таким путём уже существует.',
      content_too_long: 'Содержимое файла не должно превышать 16 384 символа.',
      invalid_json: 'Введите корректное содержимое JSON.',
    },
  },
  default: {
