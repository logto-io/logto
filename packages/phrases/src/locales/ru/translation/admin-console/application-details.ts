...
const application_details = {
  ...
  access_control: {
    ...
    description: 'Настройте правила контроля доступа на уровне приложения.',
    enable: 'Включить контроль доступа на уровне приложения',
    enable_description:
      'Включите детальный контроль доступа, чтобы ограничить пользователей, которые могут получить доступ к этому приложению. Если он отключен, все зарегистрированные пользователи в системе могут получить доступ к нему.',
    ...
    custom_allow_rules: 'Пользовательские разрешающие правила',
    custom_allow_rules_description:
      'Создайте правила, чтобы пользователи с определенными атрибутами могли получать доступ автоматически. При включении требуется хотя бы одно правило.',
    ...
    rule_table_rules: 'Правила',
    rule_table_description: 'Описание',
    rule_table_users: 'Пользователи',
    rule_table_members: 'Участники',
    rule_table_user_id: 'ID пользователя',
  ...
  saml_idp_authentication: {
    always_force_authn: 'Всегда принуждать к аутентификации',
    always_force_authn_description:
      'Требовать, чтобы пользователи снова входили в систему каждый раз, когда они получают доступ к этому приложению, даже если у них уже есть сессия в Logto.',
    always_force_authn_tip:
      'Когда включено, Logto всегда требует, чтобы пользователи снова входили в систему для этого приложения. Когда отключено, существующая сессия Logto используется повторно, если поставщик услуг не требует свежей аутентификации с ForceAuthn.',
  },
