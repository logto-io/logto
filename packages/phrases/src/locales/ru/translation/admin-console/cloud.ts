const cloud = {
  console_sso: {
    ...
    domain_bound: 'Подтверждено',
    domain_pending: 'Ожидает подтверждения',
    start_over: 'Начать заново',
    start_over_confirmation:
      'Начало заново не отменит создание коннектора, который, возможно, уже был создан. Продолжение может привести к созданию ещё одного коннектора. Вы уверены, что хотите продолжить?',
    resume_creation:
