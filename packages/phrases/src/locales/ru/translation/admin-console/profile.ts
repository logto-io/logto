const profile = {
  ...
  mfa: {
    ...
    passkeys_count_few: '{{count}} ключа доступа',
    passkeys_count_many: '{{count}} ключей доступа',
    passkeys_count_other: '{{count}} ключей доступа',
    backup_codes_count_one: '{{count}} код доступен',
    backup_codes_count_few: '{{count}} кода доступно',
    backup_codes_count_many: '{{count}} кодов доступно',
