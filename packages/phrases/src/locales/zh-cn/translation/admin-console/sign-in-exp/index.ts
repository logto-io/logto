...
const sign_in_exp = {
  ...
  branding: {
    ...
    hide_logto_branding_self_hosted_note:
      '此功能可通过 <selfHosted>自托管套餐</selfHosted> 使用。它也原生支持于 <a>Logto Cloud</a>。',
  },
  branding_uploads: {
    app_logo: {
      title: '应用 logo',
  ...
  custom_ui: {
    ...
    bring_your_ui_self_hosted_card_description:
      '通过 <selfHosted>自托管套餐</selfHosted> 上传你的自定义登录 UI。你也可以直接上传到 <a>Logto Cloud</a>。',
  ...
  account_center: {
    ...
    profile_fields: {
      ...
      disabled_hint: {
        name: '要添加此字段，请先在下方用户资料部分中将“姓名”权限设置为“可编辑/只读”。',
        avatar: '要添加此字段，请先在下方用户资料部分中将“头像”权限设置为“可编辑/只读”。',
        profile: '要添加此字段，请先在下方用户资料部分中将“资料”权限设置为“可编辑/只读”。',
        custom_data:
