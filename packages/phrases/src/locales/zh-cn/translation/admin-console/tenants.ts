const tenants = {
  ...
  settings: {
    ...
    development_description:
      '仅供测试，不应在生产中使用。无需订阅。它具有所有专业功能，但存在诸如登录横幅之类的限制。<a>了解更多</a>',
    production_description: '适用于最终用户使用的应用程序，可能需要付费订阅。<a>了解更多</a>',
  ...
  create_modal: {
    ...
    development_description: '仅用于测试，不应在生产中使用。无需订阅。',
    development_hint: '它具有所有专业功能，但存在诸如登录横幅之类的限制。',
    production_description: '适用于最终用户使用并可能需要付费订阅。',
    available_plan: '可用方案：',
    create_button: '创建租户',
    tenant_name_placeholder: '我的租户',
  },
  dev_tenant_migration: {
    title: '您现在可以通过创建“开发租户”免费尝试我们的爱好和专业功能！',
    affect_title: '这对您有何影响?',
    hint_1:
      '我们正在用两种新的租户类型：<strong>“开发”</strong>和<strong>“产品”</strong>替换旧的<strong>环境标签</strong>。',
    hint_2:
      '为确保平稳过渡和功能不中断，所有早期创建的租户将被升级为<strong>产品</strong>租户类型，并携带原先的订阅。',
    hint_3: '不用担心，您的所有其他设置将保持不变。',
    about_tenant_type: '关于租户类型',
  },
  dev_tenant_notification: {
    title: '您现在可以在开发租户中访问<a>Logto Hobby和Pro的所有功能</a>！',
    description: '完全免费，没有试用期-永远！',
  },
  delete_modal: {
    title: '删除租户',
    description_line1:
