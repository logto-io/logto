const session = {
  ...
  step_up: {
    ...
    forbidden_identifier:
      'شناسه در حین احراز هویت تقویتی مجاز نیست. بدون فیلد شناسه دوباره تلاش کنید.',
    acr_not_satisfied:
      'تأیید انجام‌شده زمینه احراز هویت درخواستی را برآورده نمی‌کند. لطفاً روش دیگری را تأیید کنید.',
    require_verification:
      'برای رسیدن به زمینه احراز هویت درخواستی، تأیید با یکی از روش‌های موجود شما لازم است.',
  },
  passkey_sign_in: {
