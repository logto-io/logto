const cloud = {
  console_sso: {
    ...
    start_over_confirmation:
      'شروع دوباره، اتصال‌دهنده‌ای را که ممکن است قبلاً ایجاد شده باشد لغو نمی‌کند. ادامه دادن ممکن است اتصال‌دهنده دیگری ایجاد کند. آیا مطمئن هستید که می‌خواهید ادامه دهید؟',
    resume_creation:
