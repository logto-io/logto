const applications = {
  ...
  dynamic_app: {
    title: 'برنامه پویا',
    subtitle: 'CIMD',
    description: 'برنامه پویا به کلاینت‌های OAuth اجازه می‌دهد بدون ثبت‌نام قبلی متصل شوند.',
    settings_description:
      'برنامه پویا به کلاینت‌های OAuth اجازه می‌دهد بدون ثبت‌نام قبلی متصل شوند. از مشخصات OAuth Client ID Metadata Document (CIMD) استفاده می‌کند.',
    beta_notice:
      'برنامه پویا در حال حاضر در نسخه بتا است. از کاوش در آن استقبال می‌کنیم و <ContactLink>بازخورد خود را به اشتراک بگذارید</ContactLink>.',
    app_id_placeholder: 'به صورت پویا توسط هر کلاینت ارائه می‌شود',
    enable_confirm_modal: {
      title: 'دسترسی کلاینت پویا فعال شود؟',
      content:
        'هر کلاینت OAuth با نشانی اینترنتی عمومی و معتبر HTTPS برای شناسه کلاینت می‌تواند بدون ثبت‌نام قبلی، مجوزدهی را برای این مستأجر آغاز کند. دسترسی همچنان محدود به حداکثر مجوزهای شما و رضایت کاربر است.',
      beta_pricing_notice:
        'برنامه پویا در دوره بتا رایگان است. پس از پایان دوره بتا ممکن است هزینه افزونه اعمال شود. از قبل به شما اطلاع می‌دهیم و می‌توانید هر زمان آن را غیرفعال کنید.',
    },
    enabled: 'برنامه پویا با موفقیت فعال شد.',
    disable_confirm_modal: {
      title: 'غیرفعال کردن برنامه پویا؟',
      content:
        'کلاینت‌های CIMD دیگر نمی‌توانند درخواست‌های مجوز جدید آغاز کنند. مجوزهای موجود حفظ می‌شوند و توکن‌های دسترسی صادرشده ممکن است تا زمان انقضا معتبر بمانند.',
    },
    disabled: 'برنامه پویا با موفقیت غیرفعال شد.',
    permissions: {
      user_title: 'کاربر',
      user_description:
        'مجوزهای درخواست‌شده توسط کلاینت‌های OAuth برای دسترسی به داده‌های کاربر خاص را انتخاب کنید.',
      grant_user_level_permissions: 'اعطای مجوزهای کاربر',
      organization_title: 'سازمان',
      organization_description:
        'مجوزهای درخواست‌شده توسط کلاینت‌های OAuth برای دسترسی به داده‌های سازمان خاص را انتخاب کنید.',
      grant_organization_level_permissions: 'اعطای مجوزهای سازمان',
