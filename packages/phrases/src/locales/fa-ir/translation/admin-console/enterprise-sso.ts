const enterprise_sso = {
  ...
  basic_info: {
    ...
    saml: {
      ...
      signing_keys_empty: 'هنوز هیچ کلید امضایی تولید نشده است.',
      generate_signing_key: 'تولید کلید جدید',
      signing_key_generated: 'کلید امضا تولید شد.',
      signing_key_activated: 'کلید امضا فعال شد.',
      signing_key_deactivated: 'کلید امضا غیرفعال شد.',
      signing_key_deleted: 'کلید امضا حذف شد.',
