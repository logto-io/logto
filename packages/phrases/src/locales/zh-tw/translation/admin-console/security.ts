const security = {
  ...
  blocklist: {
    ...
    custom_email_allowlist: {
      title: '允許自訂電子郵件地址',
      description:
        '新增規則，僅允許特定的電子郵件網域、電子郵件地址或萬用字元模式用於新註冊和新連結的電子郵件。例如：bar@example.com、@example.com、foo*@example.com、*@example.com。Gmail 地址中的點號會被忽略，因此 foo.bar@gmail.com 與 foobar@gmail.com 相符。',
