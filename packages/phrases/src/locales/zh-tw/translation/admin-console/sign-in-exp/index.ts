...
const sign_in_exp = {
  ...
  account_center: {
    ...
    prebuilt_ui: {
      ...
      flows_description:
        '結合你的域名與路徑形成你的帳戶設置 URL（例如：https://auth.foo.com/account/email）。你可以選擇添加一個 `redirect=` URL 參數，在成功更新後將用戶返回到你的應用, or an `identifier=` parameter to pre-fill the identifier input field.',
      tooltips: {
        email: '更新你的主要電子郵件地址',
        phone: '更新你的主要電話號碼',
        username: '更新你的使用者名稱',
