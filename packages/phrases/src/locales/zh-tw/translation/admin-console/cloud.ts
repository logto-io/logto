const cloud = {
  console_sso: {
    ...
    domain_bound: '已綁定',
    domain_pending: '驗證中',
    domain_verify_step: '驗證你的網域',
    domain_bind_step: '綁定電子郵件網域',
    ...
    domain_proven_unbound: '網域擁有權已驗證，但綁定尚未完成。',
    domain_verified: '網域擁有權已驗證。',
    domain_binding_pending: '驗證完成後將自動開始綁定。',
    domain_remove_description:
      '要從 Console SSO 移除 {{domain}} 嗎？移除已綁定的網域後，其電子郵件地址將無法透過 SSO 探索連接器。',
    domain_invalid: '請輸入有效的電子郵件網域。',
    domain_conflict: '此網域已綁定至其他 Console SSO 連接器。',
    domain_invalid_provider: '請先完成連線設定，再綁定此網域。',
    domain_dns_timeout: 'DNS 檢查失敗。我們會自動重試。',
    domain_recovery: '網域變更尚未完成。',
    start_over: '重新開始',
    start_over_confirmation: '重新開始可能會刪除尚未完成的 SSO 設定。是否繼續？',
    resume_creation: '發現未完成的建立作業。請使用相同的身分提供者繼續，以復原此連接器。',
  },
  general: {
    onboarding: '入門',
  },
