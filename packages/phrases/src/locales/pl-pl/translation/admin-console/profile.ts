const profile = {
  ...
  mfa: {
    ...
    passkeys_count_few: '{{count}} klucze dostępu',
    passkeys_count_many: '{{count}} kluczy dostępu',
    passkeys_count_other: '{{count}} kluczy dostępu',
    backup_codes_count_one: '{{count}} kod dostępny',
    backup_codes_count_few: '{{count}} kody dostępne',
    backup_codes_count_many: '{{count}} kodów dostępnych',
