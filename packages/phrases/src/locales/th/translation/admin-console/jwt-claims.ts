const jwt_claims = {
  ...
  user_jwt: {
    ...
    custom_data_in_id_token: {
      title: 'เพิ่มข้อมูลผู้ใช้แบบกำหนดเองไปยังโทเค็น ID',
      tip: 'โทเค็น ID คือการยืนยันตัวตนที่ไคลเอนต์ได้รับหลังจากเข้าสู่ระบบเพื่อพิสูจน์ว่าผู้ใช้เป็นใคร มันมีไว้สำหรับไคลเอนต์ มีการเรียกร้องตัวตนของผู้ใช้สำหรับการแสดงผลหรือการสร้างเซสชัน',
      description:
        'เปิดใช้งานเพื่อรวม<a>ข้อมูลผู้ใช้แบบกำหนดเอง</a>ของคุณในโทเค็น ID ทำให้ไคลเอนต์สามารถเข้าถึงรายละเอียดตัวตนเหล่านี้ได้ทันทีโดยไม่ต้องเรียกโปรไฟล์เพิ่มเติม',
    },
  },
