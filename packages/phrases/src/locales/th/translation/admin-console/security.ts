const security = {
  ...
  password_policy: {
    ...
    enable_password_expiration_description:
      'กำหนดให้ผู้ใช้รีเซ็ตรหัสผ่านเป็นระยะ ผู้ใช้ที่มีอยู่ซึ่งไม่มีการบันทึกวันที่เปลี่ยนรหัสผ่านจะถูกประเมินตามวันที่สร้างบัญชี',
    ...
    expiration_reminder: 'การแจ้งเตือนการหมดอายุ (จำนวนวันก่อนหมดอายุ)',
    expiration_reminder_description:
      'จำนวนวันก่อนหมดอายุเพื่อเตือนผู้ใช้และแจ้งให้รีเซ็ตรหัสผ่าน ผู้ใช้สามารถข้ามการแจ้งเตือนและดำเนินการลงชื่อเข้าใช้ต่อได้',
    expiration_reminder_error:
      'ระยะเวลาการแจ้งเตือนการหมดอายุต้องอยู่ระหว่าง 0 ถึงระยะเวลาที่ใช้งานได้ ({{max}} วัน)',
  },
  sentinel_policy: {
